...
class Driver extends CI_Controller {
    ...
    public function create() {
        ...
        if ($this->input->post('name') != "") {
            ...
            $d = array('name' => $this->input->post('name'), 'companyID' => $this->input->post('companyID'), 'busID' => $this->input->post('busID'), 'contact' => $this->input->post('contact'), 'email' => $this->input->post('email'),'image' => $userfile, 'created' => date('Y-m-d H:i:s'), 'active' => 'true');
