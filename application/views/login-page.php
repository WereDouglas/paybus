        ...
        *********************************************************************************************************************************************************** -->
        ...
        <div id="login-page">
            <div class="container">
                ...
                <form id="station-form" class="form-login" name="login-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/login/submit'  method="post">
                    ...
                    <div class="login-wrap">
                        ...
                        <div class="registration">
                            ...
                            <a class="" href="<?php echo base_url() . "index.php/welcome/register"; ?>">
                                Create an account
                            </a>
                        </div>
                        <div class="registration">
